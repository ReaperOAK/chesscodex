  ...
  return (
    <>
      <SEO
        ...
        keywords={'Kolkata Chess Academy, collaborate, partnership, chess, community'}
        image={'https://kolkatachessacademy.in/kca.png'}
        url={'https://kolkatachessacademy.in/collaborate-with-us'}
        type="website"
        canonical={'https://kolkatachessacademy.in/collaborate-with-us'}
        structuredData={{
