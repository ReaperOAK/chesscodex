  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-center px-4">
      <div className="max-w-md p-6 bg-white rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold mb-4 text-blue-600">Under Maintenance</h1>
        <p className="text-lg mb-8">Our site is currently undergoing maintenance. We’ll be back soon!</p>
        <div className="flex justify-around text-2xl font-semibold text-blue-500">
          <div>
      ...
      <p className="text-gray-600 mt-8">
        ...
        <a href="mailto:info@chessacademy.com" className="text-blue-600 underline ml-1">info@chessacademy.com</a>.
      </p>
    </div>
  );
};
