  ...
  return (
    <section className="py-16">
      <div className="max-w-5xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-8">Pro Members - Kolkata Chess Academy</h2>
        ...
        <h3 className="text-2xl font-bold text-gray-800 mb-6">Our Offerings:</h3>
